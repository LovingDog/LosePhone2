...
public  class ConsUtils {
    ...
    public static final int SET_LOCATION_ALARM_DONE=8;//地点闹钟设置成功
    ...
    public static final String ALARM_LOCATION_LON="Lon";//经
    public static final String ALARM_LOCATION_LAT="Lat";//维度
    public static final String ALARM_LOCATION_NAME="Location";//位置
    public static final String ALARM_DES="des";//位置
