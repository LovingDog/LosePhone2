...
public class PublishPopWindow extends PopupWindow implements View.OnClickListener {
    ...
    private OnPopWindowClick mOnPopWindowClick;
    private View rootView;
    private RelativeLayout contentView;
    private Activity mContext;

    public PublishPopWindow(Activity context,OnPopWindowClick onPopWindowClick) {
    ...
    public void showMoreWindow(View anchor) {
        ...
        rootView.findViewById(R.id.lay_location_clock).setOnClickListener(this);
        rootView.findViewById(R.id.lay_clock).setOnClickListener(this);
...
//            }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.lay_clock:
                mOnPopWindowClick.click(0);
                break;
            case R.id.lay_location_clock:
                mOnPopWindowClick.click(1);
                break;
            case R.id.ll_close:
                if (isShowing()) {
