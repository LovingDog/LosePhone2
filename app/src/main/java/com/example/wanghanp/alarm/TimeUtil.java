...
public class TimeUtil {
    ...
    public static String timeParse(long duration) {
        String time = "" ;
        long minute = duration * 1000 / 60000 ;
        long seconds = duration * 1000 % 60000 ;
    ...
    public static int getDate(Long millisecond){
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Date date = new Date(millisecond);
        int a = date.getDay();
        return a;
    ...
    public static String getSpaceTime(Long millisecond) {
        ...
        //3天之内
        else if (spaceSecond/(60*60*24)>0&&spaceSecond/(60*60*24)<5){
